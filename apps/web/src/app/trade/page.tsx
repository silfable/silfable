          ...
          <section className="railSection">
            ...
            <div className="mb-4 flex items-start justify-between gap-3">
              <div className="flex min-w-0 items-start gap-2 font-mono text-[10px] text-white">
                <span className={`mt-1 h-2 w-2 shrink-0 rounded-sm ${runtimeUsage.totalTokens > 0 ? "bg-[var(--sc-ice)]" : "bg-white opacity-50"}`} />
                <span className="break-all">{runtimeUsage.model}</span>
              </div>
              {isFreeRuntimeModel && <span className="shrink-0 rounded-md border border-[var(--sc-ice)]/35 px-2 py-1 font-mono text-[7px] uppercase tracking-[0.12em] text-[var(--sc-ice)]">Free</span>}
            </div>
            ...
            <div className="mb-4 border-b border-[rgb(148,163,184,0.16)] pb-4" title="Input tokens reported by the provider for the most recent AI request.">
              ...
              <div className="h-1 overflow-hidden rounded-full bg-white/[0.12]">
                <div className="h-full rounded-sm bg-gradient-to-r from-[var(--sc-ice)] to-[var(--sc-violet)] transition-[width] duration-200" style={{ width: `${contextBarPercent}%` }} />
              </div>
