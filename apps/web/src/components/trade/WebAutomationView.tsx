      ...
      <div className="flex flex-1 flex-col gap-4 p-5">
        {strategy.kind === "DCA" ? (
          ...
          <div className="grid grid-cols-2 gap-px overflow-hidden rounded-[12px_28px_12px_12px] border border-[var(--line)] bg-[var(--line)]">
            <div className="bg-[var(--sc-abyss)] p-4"><span className="font-mono text-[8px] uppercase tracking-[0.14em] text-[var(--muted)]">Take profit</span><strong className="mt-2 block text-lg text-[var(--paper)]">${strategy.takeProfitPriceUsd ?? "—"}</strong></div>
            <div className="bg-[var(--sc-abyss)] p-4"><span className="font-mono text-[8px] uppercase tracking-[0.14em] text-[var(--muted)]">Stop loss</span><strong className="mt-2 block text-lg text-[var(--paper)]">${strategy.stopLossPriceUsd ?? "—"}</strong></div>
          </div>
        )}
