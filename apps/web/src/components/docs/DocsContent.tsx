    ...
    <article className="min-w-0">
      <section id="introduction" className="scroll-mt-36 border-b border-black/15 pb-16">
        ...
        <p className="mt-9 max-w-2xl text-lg leading-8 text-black/55">
          Silfable brings Jupiter swaps, Pump.fun launches, Solana portfolio context, automation proposals, and wallet-reviewed execution into one operator workspace. Connected EVM routes remain available when a workflow needs to move beyond Solana.
        </p>
      ...
      <section id="quick-start" className="scroll-mt-36 border-b border-black/15 py-16">
        ...
        <p className="doc-lead">Choose web or desktop, connect the Solana wallet you intend to use, then configure only the providers required by your workflow.</p>
        <ol className="mt-10 space-y-7">
          {[
            ["Choose", "Use desktop for encrypted local-vault signing, or web with a connected browser wallet."],
            ["Configure", "Verify your Solana RPC, Jupiter access, and Pump.fun metadata provider as required. Additional network integrations can be connected separately."],
